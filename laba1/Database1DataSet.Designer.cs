...
namespace WindowsFormsApplication3 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(string Firstname, string Lastname, string Surname, string Group) {
...
namespace WindowsFormsApplication3.Database1DataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Firstname], [Lastname], [Surname], [Group]) VALUES (@" +
                "Firstname, @Lastname, @Surname, @Group);\r\nSELECT Id, Firstname, Lastname, Surnam" +
                "e, [Group] FROM Users WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Firstname] = @Firstname, [Lastname] = @Lastname, [Surname] = @Surname, [Group] = @Group WHERE (([Id] = @Original_Id) AND ((@IsNull_Firstname = 1 AND [Firstname] IS NULL) OR ([Firstname] = @Original_Firstname)) AND ((@IsNull_Lastname = 1 AND [Lastname] IS NULL) OR ([Lastname] = @Original_Lastname)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Group = 1 AND [Group] IS NULL) OR ([Group] = @Original_Group)));
SELECT Id, Firstname, Lastname, Surname, [Group] FROM Users WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Firstname, Lastname, Surname, [Group] FROM dbo.Users";
        ...
        public virtual int FillBy(Database1DataSet.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Firstname, string Original_Lastname, string Original_Surname, string Original_Group) {
        ...
        public virtual int Insert(string Firstname, string Lastname, string Surname, string Group) {
            if ((Firstname == null)) {
        ...
        public virtual int Update(string Firstname, string Lastname, string Surname, string Group, int Original_Id, string Original_Firstname, string Original_Lastname, string Original_Surname, string Original_Group, int Id) {
            if ((Firstname == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Firstname, string Lastname, string Surname, string Group, int Original_Id, string Original_Firstname, string Original_Lastname, string Original_Surname, string Original_Group) {
            return this.Update(Firstname, Lastname, Surname, Group, Original_Id, Original_Firstname, Original_Lastname, Original_Surname, Original_Group, Original_Id);
        }
    }
